...
"border-image: url(:/Images/Beige1.png);")
        ...
        self.lineRestoName.setGeometry(QtCore.QRect(70, 50, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
...
"border-radius:10px;")
        ...
        self.lineTypeNourriture.setGeometry(QtCore.QRect(70, 220, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdRue.setGeometry(QtCore.QRect(70, 90, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdVille.setGeometry(QtCore.QRect(70, 130, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdPostal.setGeometry(QtCore.QRect(70, 180, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdNum.setGeometry(QtCore.QRect(210, 180, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineCountry.setGeometry(QtCore.QRect(210, 130, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.comboBoxGammePrix.setGeometry(QtCore.QRect(70, 270, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"")
        ...
        self.labelHeureOuverture.setGeometry(QtCore.QRect(70, 310, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
        ...
        self.timeEditHeureDebut.setGeometry(QtCore.QRect(70, 360, 101, 21))
...
"border-radius:10px;")
        ...
        self.labelVisite2.setGeometry(QtCore.QRect(190, 365, 20, 16))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        ...
        self.timeEditHeureFin.setGeometry(QtCore.QRect(220, 360, 101, 21))
...
"border-radius:10px;")
        ...
        self.checkBoxFaitLivraison.setGeometry(QtCore.QRect(70, 390, 251, 21))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
