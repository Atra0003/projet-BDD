...
# Form implementation generated from reading ui file 'RestaurateurAddResto.ui'
#
...
"border-image: url(:/Images/Beige1.png);")
        ...
        self.labelAddResto = QtWidgets.QLabel(self.widget)
        self.labelAddResto.setGeometry(QtCore.QRect(0, 0, 381, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(19)
        self.labelAddResto.setFont(font)
        self.labelAddResto.setAlignment(QtCore.Qt.AlignCenter)
        self.labelAddResto.setObjectName("labelAddResto")
        self.lineRestoName = QtWidgets.QLineEdit(self.widget)
        self.lineRestoName.setGeometry(QtCore.QRect(70, 40, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
...
"border-radius:10px;")
        ...
        self.lineTypeNourriture.setGeometry(QtCore.QRect(70, 210, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdRue.setGeometry(QtCore.QRect(70, 80, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdVille.setGeometry(QtCore.QRect(70, 120, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdPostal.setGeometry(QtCore.QRect(70, 170, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineAdNum.setGeometry(QtCore.QRect(210, 170, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.lineCountry.setGeometry(QtCore.QRect(210, 120, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.comboBoxGammePrix.setGeometry(QtCore.QRect(70, 260, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"")
        ...
        self.labelHeureOuverture.setGeometry(QtCore.QRect(70, 300, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
        ...
        self.timeEditHeureDebut.setGeometry(QtCore.QRect(70, 350, 101, 21))
...
"border-radius:10px;")
        ...
        self.labelVisite2.setGeometry(QtCore.QRect(190, 355, 20, 16))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        ...
        self.timeEditHeureFin.setGeometry(QtCore.QRect(220, 350, 101, 21))
...
"border-radius:10px;")
        ...
        self.checkBoxFaitLivraison.setGeometry(QtCore.QRect(70, 380, 251, 21))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(12)
...
"border-radius:10px;")
        ...
        self.labelError.setGeometry(QtCore.QRect(0, 410, 400, 20))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        ...
        self.buttonBoxOkRetour.setStyleSheet("")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelAddResto.setText(_translate("MainWindow", "Ajouter un Nouveau Restaurant"))
