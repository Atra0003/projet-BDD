...
# Form implementation generated from reading ui file 'PlatAsiatique.ui'
#
...
"border-image: url(:/Images/Beige1.png);")
        ...
        self.labelOther.setGeometry(QtCore.QRect(10, 10, 361, 51))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        ...
        self.listWidgetRestoObtenu = QtWidgets.QListWidget(self.widget)
        self.listWidgetRestoObtenu.setGeometry(QtCore.QRect(40, 80, 311, 311))
        self.listWidgetRestoObtenu.setStyleSheet("border-image: url(:/Images/Beige2.png);\n"
"border-radius:6px;")
        self.listWidgetRestoObtenu.setObjectName("listWidgetRestoObtenu")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelOther.setText(_translate("MainWindow", "Non-asiatique avec le + plats asiat"))
from . import res_rc
